...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المنتجات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ إضافة
                    منتج</span>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                ...
                <div class="card-body">
                    ...
                    <form class="___class_+?9___" action="{{ route('products.store') }}" method="POST"
