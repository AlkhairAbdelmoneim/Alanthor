    ...
    <div class="row row-sm">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                ...
                <div class="card-body">
                    <form class="___class_+?9___" action="{{ route('services.update', $service->id) }}" method="POST"
                        ...
                        <div class="___class_+?9___">
                            ...
                            <input type="hidden" name=" service[][translation_lang]" class="form-control"
                                value="{{ $service->translation_lang }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="service[0][name]" class="form-control"
                                    placeholder="@lang('site.'.$service->translation_lang.'.name')"
                                    value="{{ $service->name }}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">@lang('site.'.$service->translation_lang.'.description')
                                </label>
                                <textarea name="service[0][description]" style="margin-top: 5px; width:100%"
                                    class="form-control "
                                    placeholder="@lang('site.'.$service->translation_lang.'.description')" rows="3"
                                    cols="12">{{ $service->description }}</textarea>
            ...
            <div class="panel panel-primary tabs-style-3">
                <div class="tab-menu-heading">
                    <div class="tabs-menu ">
                        ...
                        <ul class="nav panel-tabs">
                            ...
                            @foreach ($service->services as $index => $lang)
                ...
                <div class="panel-body tabs-menu-body">
                    <div class="tab-content">
                        ...
                        @foreach ($service->services as $lang)
                            <div class="tab-pane active" id="tab11{{ $index }}">

                                <form class="___class_+?9___" action="{{ route('services.update', $lang->id) }}"
